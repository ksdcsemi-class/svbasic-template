...
// KSDC Proprietary
// Course: 반도체설계검증 언어기초
// File  : class03_ex18_always_ff_problem_blank.sv
// Date  : 2026-02-28
// Author: Jongsup Baek <jongsup.baek@ksdcsemi.com>
//
// execution command 
//    $> cd sim
//    $> xrun -f ex18_problem_blank.f -input ../../shm.tcl
//////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////
   // Comment #1 : - multiple blocks can drive same variable (y1)
...
//////////////////////////////////////////////////////////
   // Comment #2 : Compilation Error, multiple event control
   always_ff begin
      @(posedge clk);
         y3<= a +1;
      @(posedge clk);
